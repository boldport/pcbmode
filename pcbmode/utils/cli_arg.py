...
def setup():
    ...
    argp.add_argument('-b', '--board-name', dest='boards', required=True, nargs=1,
                      help='The name of the board. The location of the files should \
                            be specified in the configuration file, otherwise defaults \
                            are used')
     
    argp.add_argument('-f', '--filein', required=False, dest='filein',
